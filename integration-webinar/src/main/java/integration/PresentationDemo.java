...
public final class PresentationDemo {
  ...
  public static void main(final String[] args) throws Exception {
    ...
    final Sink<Order, ?> logOrder = Sink.foreach(order -> System.out.println("Order: " + order));
    final Sink<Invoice, ?> logInvoice = Sink.foreach(invoice -> System.out.println("Invoice: " + invoice));
    ...
    switch(Transport.valueOf(inputURI.getScheme())) {
      case file:
    ...
    switch(Transport.valueOf(outputURI.getScheme())) {
      case file:
